...
static const char *const yytname[] =
{
  ...
  "EOL", "'('", "')'", "$accept", "calclist", "expr", YY_NULLPTR
};
...
#line 22 "calculadora.y"
                        { printf("= %.4f\n", (yyvsp[-1].fval)); }
#line 1065 "calculadora.tab.c"
    break;

  case 4: /* expr: NUMBER  */
#line 26 "calculadora.y"
                           { (yyval.fval) = (yyvsp[0].fval); }
#line 1071 "calculadora.tab.c"
    break;

  case 5: /* expr: SQRT '(' expr ')'  */
#line 27 "calculadora.y"
                           { (yyval.fval) = sqrt((yyvsp[-1].fval)); }
#line 1077 "calculadora.tab.c"
    break;
